...
# e2etabularmlpipeline documentation build
...
from e2etabularmlpipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "e2etabularmlpipeline"
author = "Kedro"
...
htmlhelp_basename = "e2etabularmlpipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "e2etabularmlpipeline.tex",
        "e2etabularmlpipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "e2etabularmlpipeline",
        "Project e2etabularmlpipeline codebase.",
        "Data-Science",
    )
]
